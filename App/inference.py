...
class MusicSeparationModel:
    ...
    def Extract_with_Model(self, type, audio, model):
        ...
        name = model['Name']
        if type =='Music':
            quality = self.Quality_Music;  text = 'Extract Music'
        elif type=='Vocal':
            quality = self.Quality_Vocal;  text = 'Extract Vocals'
        elif type=='Bleed_Music':
            quality = self.Quality_Bleed;  text = 'Remove Music Bleedings'
        elif type=='Bleed_Vocal':
            quality = self.Quality_Bleed;  text = 'Vocal Bleedings in Music'
        elif type=='Remove_Music':
            quality = self.Quality_Bleed;  text = 'Music in Vocal Bleedings'
